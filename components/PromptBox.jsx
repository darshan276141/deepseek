...
const PromptBox = ({ setisLoading, isLoading }) => {
    ...
    const sendPrompt = async (e) => {
        ...
        try {
            ...
            // saving the prompt in selected chat 
            setSelectedChat((prev) => ({
                ...prev,
                messages: [...prev.messages, userPrompt]
            }))
            const { data } = await axios('/api/chat/ai', {
    ...
    return (
        <form onSubmit={sendPrompt}
            className={`w-full ${selectedChat && selectedChat.messages && selectedChat.messages.length > 0 ? "max-w-3xl" : "max-w-2xl"} bg-[#404045] p-4 rounded-3xl mt-4 transition-all`}>
            <textarea
            ...
            <div className='flex items-center justify-between text-sm'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <button type="submit" className={`${prompt ? "bg-primary" : "bg-[#71717a]"}
